  ...
  (custom-set-faces
   ...
   `(mode-line-inactive
     ((t (:inherit mode-line-inactive
                   :box (:line-width ,mode-line-height :style flat-button)))) t)))
(add-hook 'load-theme-hook #'flat-style)
#+end_src
...
(add-hook 'load-theme-hook #'(lambda () (solaire-global-mode +1)))
#+end_src
** auto-dark
#+begin_src emacs-lisp
(eat/pkg auto-dark)
...
(setq eat/theme 'spacemacs-light
