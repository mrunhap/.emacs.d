...
*** Can’t find emacs_module.h?
Config ==rime-emacs-module-header-root= to =emacs/include=.
#+begin_example
...
*** Can’t find rime_api.h?
Config =rime-librime-root= to =librime=.
...
(setq company-idle-delay 0.1) ;; time for snippet expand
