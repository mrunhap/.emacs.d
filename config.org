...
(with-eval-after-load 'copilot
  ...
  ;; Don't warning when file is too big.
  (defun +copilot--get-source-a-around (fn &rest args)
    "Advice function for `copilot--get-source'."
    (cl-letf (((symbol-function #'warn) #'message))
      (apply fn args)))
  (advice-add #'copilot--get-source :around #'+copilot--get-source-a-around)
