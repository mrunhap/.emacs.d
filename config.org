...
(autoload #'tabnine-install-binary "tabnine" nil t)
(autoload #'tabnine-start-process "tabnine" nil t)

(when (file-directory-p "~/.TabNine/")
  ;; TODO some package(like eglot) will rewrite completion-at-point-functions
  ;; (add-to-list 'completion-at-point-functions #'tabnine-completion-at-point)
  ;; (add-hook 'kill-emacs-hook #'tabnine-kill-process)
  ;; (add-hook 'prog-mode-hook #'tabnine-start-process)
  ;; (with-eval-after-load "meow"
  ;;   (add-to-list 'tabnine-enable-predicates #'meow-insert-mode-p))
  )
#+end_src
** yasnippet
#+begin_src elisp
