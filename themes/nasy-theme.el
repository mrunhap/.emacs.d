...
(let* ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
   ...
   `(variable-pitch                       ((,class (:family ,nasy-theme-variable-pitch-font))))
   ...
   `(company-scrollbar-bg                 ((,class (:background ,n-牙))))
   `(company-scrollbar-fg                 ((,class (:background ,n-茶 :foreground ,n-缟))))
   ...
   `(font-lock-keyword-face               ((,class (:foreground ,n/墨缟 :weight bold))))
   `(font-lock-negation-char-face         ((,class (:foreground ,n-珈琲椶))))
   `(font-lock-string-face                ((,class (:foreground ,n/靛青湖蓝))))
   `(font-lock-type-face                  ((,class (:foreground ,n-松绿 :slant italic :weight bold))))
   `(font-lock-variable-name-face         ((,class (:foreground ,n-茶))))
   `(font-lock-warning-face               ((,class (:background ,n-鸭黄 :foreground ,n-墨 :weight bold))))
   ...
   `(vterm-color-inverse-video            ((,class (:background ,n-墨))))
   ...
   `(tree-sitter-hl-face:function.builtin ((,class (:inherit tree-sitter-hl-face:function))))
   `(tree-sitter-hl-face:function.special ((,class (:inherit tree-sitter-hl-face:function))))
   `(tree-sitter-hl-face:constructor      ((,class (:inherit tree-sitter-hl-face:type :bold nil))))
   `(tree-sitter-hl-face:property         ((,class (:inherit font-lock-constant-face :bold nil))))
   `(tree-sitter-hl-face:operator         ((,class (:background ,n-蠟白 :bold t :inherit font-lock-negation-char-face))))))
